<template>
  <div class="pb-3">
    ...
    <h5>😭 But my stuff!</h5>
    <p>
      I know breakups are hard, but Sooner takes care of this heart-wrenching process by deleting that stuff for you. If something on your list expires, so be it. Trust me, it's liberating!
    </p>
    <h5>😕 Okay you're throwing my stuff away... what am I left with?</h5>
    <p>
      Set up this way, your Sooner list is only ever filled with things you care about right now. It's easy to to add stuff you like so go crazy. If you really feel like something on your list is important, you should read it <em>sooner</em> rather than later.
    </p>
    <p class="text-center">
